...
const mockData: Supplier[] = [
      ...
      },
      {
            ...
            country: 'Switzerland',
            contact: '+41 22 9876543',
            email: 'info@medisource.ch',
            rating: 5,
            status: 'Active',
            certifications: ['GMP', 'ISO 13485', 'CE'],
            lastAudit: '2024-11-01',
      },
      {
            key: '3',
            id: 'SUP-IMP-003',
            name: 'Asian Chemicals Corp',
            country: 'India',
            contact: '+91 22 44556677',
            email: 'sales@asianchem.in',
            rating: 3.5,
            status: 'Pending',
      ...
      },
      {
            key: '4',
            id: 'SUP-IMP-004',
            name: 'Euro Medical Supplies',
            country: 'France',
            contact: '+33 1 23456789',
            email: 'contact@euromedical.fr',
            rating: 4,
            status: 'Active',
            certifications: ['GMP', 'ISO 9001', 'FDA', 'CE'],
            lastAudit: '2024-09-10',
      },
      {
            key: '5',
            id: 'SUP-IMP-005',
            name: 'Pacific Pharma Trading',
            country: 'China',
            contact: '+86 10 87654321',
            email: 'info@pacificpharma.cn',
            rating: 3,
            status: 'Inactive',
            certifications: ['GMP'],
...
export default function SuppliersImportPage() {
      ...
      const handleFinish = (values: any) => {
            if (editingRecord) {
                  ...
                  const newSupplier: Supplier = {
                        ...
                        id: `SUP-IMP-${String(data.length + 1).padStart(3, '0')}`,
                        ...values,
                  };
      ...
      return (
            <div className="space-y-6">
                  <div className="mb-6">
                        <h1 className="text-2xl font-bold text-slate-800">Supplier Management (Import)</h1>
                        <p className="text-slate-500">Manage international suppliers and their certifications</p>
                  </div>
                  ...
                  >
                        ...
                        >
                              <Input placeholder="+XX XXX XXXXXXX" />
                        </Form.Item>
